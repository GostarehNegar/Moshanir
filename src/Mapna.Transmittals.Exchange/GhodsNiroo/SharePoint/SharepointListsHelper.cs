        ...
        public async Task<bool> EnsureJobList()
        {
            ...
            try
            {
                ...
                var fields = new List<Tuple<string, string>>() {
                    ...
                    new Tuple<string, string>("StatusReason",
                        "<Field Type='Note' DisplayName='StatusReason' Required='FALSE'  NumLines='6' RichText='FALSE' RichTextMode='Compatible'  Sortable='FALSE'  AppendOnly='FALSE' Version='1' />"),
