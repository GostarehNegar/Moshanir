...
{
    public interface IMessageHeader : IDictionary<string, string>
    {
        bool TrySetValue(string key, object value);
        bool TrySetValue<T>(string key, T value);
        bool TryGetValue(string key, Type type, out object result);
    ...
    public class MessageHeader : ConcurrentDictionary<string, string>, IMessageHeader
    {
        internal delegate bool ParseDelegate<T>(string s, out T res);
        public MessageHeader()
        {

        }
        public MessageHeader(IDictionary<string, string> headers) : base(headers)
        {
